...
const VolunteerForm = ({ selectedForm }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = (data) => {
    ...
    localStorage.setItem("volunteerFormData", JSON.stringify(data));
        ...
        >
          ...
          <div className="mb-5">
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900"
            >
              Do you have any training or experience that would be relevant to
              volunteering with Kick Ass Seniors?
            </label>
            <div className="mt-1 text-sm text-gray-500" id="user_avatar_help">
              ex: Administration / Accountancy / Book keeping /Event Management
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="mb-5">
              <label
                ...
                className="block mb-2 text-sm font-medium text-gray-900"
              >
                How did you hear about Kick Ass Seniors?
              </label>
              <input
                type="text"
                id="howHeard"
